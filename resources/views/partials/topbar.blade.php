                            ...
                            <div id="DZ_W_Notification1" class="widget-media dlab-scroll p-3" style="height:380px;">
                                <ul class="timeline">
                                        ...
                                        <div class="timeline-panel">
                                            <div class="media me-2">
                                                <img alt="image" width="50"
                                                    src="https://asset.kompas.com/crops/J7657-2H778JRFT8RWQQ17JImkI=/0x0:900x600/750x500/data/photo/2020/01/13/5e1c2db5d7623.jpeg">
                                            </div>
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media me-2">
                                                <img alt="image" width="50" src="https://asset.kompas.com/crops/J7657-2H778JRFT8RWQQ17JImkI=/0x0:900x600/750x500/data/photo/2020/01/13/5e1c2db5d7623.jpeg>
                                            </div>
                                            <div class=" media-body">
                                                <h6 class="mb-1">Dr sultads Send you Photo</h6>
                                                <small class="d-block">29 July 2020 - 02:26 PM</small>
                        ...
                        <div class="dropdown header-profile2">
                            <a class="nav-link ms-0" href="javascript:void(0);" role="button" data-bs-toggle="dropdown"
                                ...
                                <div class="header-info2 d-flex align-items-center">
                                    ...
                                    <img src="https://asset.kompas.com/crops/J7657-2H778JRFT8RWQQ17JImkI=/0x0:900x600/750x500/data/photo/2020/01/13/5e1c2db5d7623.jpeg.jpg"
                                        alt="">
                                </div>
                            </a>
                                ...
                                <div class="card mb-0">
                                    <div class="card-header p-3">
                                        <ul class="d-flex align-items-center">
                                            <li>
                                                <img src="https://asset.kompas.com/crops/J7657-2H778JRFT8RWQQ17JImkI=/0x0:900x600/750x500/data/photo/2020/01/13/5e1c2db5d7623.jpeg"
                                                    class="ms-0" alt="">
                                            </li>
                                            <li class="ms-2">
