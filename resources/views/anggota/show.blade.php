            ...
            <div class="col-xl-12">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div class="user">
                                        ...
                                        <div>
                                            <h2 class="mb-0">{{ $anggota->nama }}</h2>
                                            <p class="text-primary font-w600">{{ $anggota->status }}</p>
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-xl-3 col-xxl-6 col-sm-6">
                                        ...
                                        <ul class="student-details">
                                            ...
                                            <li><span>Address:</span>
                                                <h5 class="mb-0">Jakarta, Indonesia</h5>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-xl-3 col-xxl-6 col-sm-6">
                                    ...
                                    <div class="col-xl-3 col-xxl-6 col-sm-6">
                                        <ul class="student-details">
                                            ...
                                            <li><span>Email:</span>
                                                <h5 class="mb-0">Historia@mail.com</h5>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="card h-auto mt-4">
                    <div class="card-header border-0 p-3">
                        <h4 class="heading mb-0">Riwayat Prestasi</h4>
                    </div>
